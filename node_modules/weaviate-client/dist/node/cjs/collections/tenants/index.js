...
const checkSupportForGRPCTenantsGetEndpoint = (dbVersionSupport) => __awaiter(void 0, void 0, void 0, function* () {
...
const tenants = (connection, collection, dbVersionSupport) => {
    const getGRPC = (names) => checkSupportForGRPCTenantsGetEndpoint(dbVersionSupport)
        .then(() => connection.tenants(collection))
        .then((builder) => builder.withGet({ names }))
        .then(index_js_2.Deserialize.tenantsGet);
    const getREST = () => new index_js_1.TenantsGetter(connection, collection).do().then((tenants) => {
        const result = {};
    ...
    return {
        ...
        getByName: (tenant) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (yield dbVersionSupport.supportsTenantGetRESTMethod().then((check) => !check.supports)) {
                return getGRPC([tenantName]).then((tenants) => { var _a; return (_a = tenants[tenantName]) !== null && _a !== void 0 ? _a : null; });
            }
            return connection
