import { BQConfig, ModuleConfig, MultiVectorConfig, MuveraEncodingConfig, PQConfig, PQEncoderDistribution, PQEncoderType, RQConfig, SQConfig, VectorDistance, VectorIndexConfigDynamic, VectorIndexConfigFlat, VectorIndexConfigHNSW, VectorIndexFilterStrategy } from '../../config/types/index.js';
...
export type QuantizerConfigCreate = PQConfigCreate | BQConfigCreate | SQConfigCreate | RQConfigCreate | Record<string, any>;
