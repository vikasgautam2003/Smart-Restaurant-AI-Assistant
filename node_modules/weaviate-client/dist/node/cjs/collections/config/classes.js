...
class MergeWithExisting {
    ...
    static flat(current, update) {
        if ((parsing_js_1.QuantizerGuards.isPQUpdate(update.quantizer) && (current === null || current === void 0 ? void 0 : current.bq).enabled) ||
            (parsing_js_1.QuantizerGuards.isBQUpdate(update.quantizer) && (current === null || current === void 0 ? void 0 : current.pq).enabled))
